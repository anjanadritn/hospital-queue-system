...
export const hospitalApi = {
  ...
  cancelAppointment: async (bookingId, reason = '') => {
    const response = await apiClient.post(`/appointments/${bookingId}/cancel`, { reason });
    return response.data;
  },
  ...
  changePassword: async (currentPassword, newPassword, confirmPassword) => {
    const response = await apiClient.post('/patients/me/change-password', {
  ...
  removeProfilePicture: async () => {
    const response = await apiClient.delete('/patients/me/picture');
    return response.data;
  },
  ...
  toggleDoctorLeave: async (doctorId, onLeave = true, reason = '') => {
    const response = await apiClient.patch(`/admin/doctors/${doctorId}/leave`, {
      on_leave: onLeave,
      reason: reason || (onLeave ? 'Doctor is on leave today' : ''),
    });
    return response.data;
  },
