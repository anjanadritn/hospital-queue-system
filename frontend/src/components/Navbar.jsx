            ...
            <>
              <Link
                ...
                className={`flex items-center gap-1.5 px-3 py-1.5 rounded-xl transition ${
                  isActive('/patient') && !location.search ? 'bg-white text-sky-700 shadow-xs' : 'text-slate-600 hover:text-slate-900'
                }`}
              >
              ...
              <Link
                to="/patient/profile"
                className={`flex items-center gap-1.5 px-3 py-1.5 rounded-xl transition ${
                  isActive('/patient/profile') || isActive('/profile') ? 'bg-white text-sky-700 shadow-xs' : 'text-slate-600 hover:text-slate-900'
                }`}
              >
              ...
              <Link
                to="/patient/history"
                className={`flex items-center gap-1.5 px-3 py-1.5 rounded-xl transition ${
                  isActive('/patient/history') || (isActive('/patient/profile') && location.search.includes('medical-history')) ? 'bg-white text-teal-700 shadow-xs' : 'text-slate-600 hover:text-slate-900'
                }`}
              >
              ...
              >
                {user.profile_picture ? (
                  <img
                    ...
                    alt={user.name || 'User'}
                    className="w-8 h-8 rounded-full object-cover ring-2 ring-sky-500/30 group-hover:ring-sky-500 transition shadow-xs"
                  />
                ) : (
                  <div className="w-8 h-8 rounded-full bg-gradient-to-tr from-sky-600 to-teal-500 text-white flex items-center justify-center font-extrabold text-xs shadow-xs ring-2 ring-sky-500/20 group-hover:ring-sky-500 transition">
