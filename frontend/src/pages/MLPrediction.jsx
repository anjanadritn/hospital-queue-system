      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-10">
          <div className="inline-flex items-center gap-1.5 text-xs font-bold uppercase tracking-wider text-amber-700 bg-amber-50 px-3 py-1 rounded-full border border-amber-200 mb-3">
            ...
            <span>Machine Learning Intelligence Module</span>
          </div>
          <h1 className="text-3xl sm:text-4xl font-extrabold text-slate-900 tracking-tight mb-2">
            AI Wait Time & Consultation Duration Predictor
          </h1>
          <p className="text-xs sm:text-sm text-slate-500 leading-relaxed">
            Trained Random Forest Regressor executing on our Flask backend to forecast patient consultation pace based on department load, symptom complexity, and queue depth.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-7 bg-white rounded-3xl p-6 sm:p-8 border border-slate-200/80 shadow-xs">
            <h2 className="text-base font-bold text-slate-900 mb-1 flex items-center gap-2">
              ...
              <span>Configure Prediction Parameters</span>
            </h2>
            <p className="text-xs text-slate-500 mb-6">
              Adjust variables to simulate waiting times for different hospital scenarios.
            </p>
            ...
            <form onSubmit={handlePredict} className="space-y-6">
              ...
              <div>
                <label className="block text-xs font-bold text-slate-700 uppercase tracking-wider mb-2">
                  Patient Clinical Symptoms (Select 1 or more)
                </label>
              ...
              >
                ...
                <span>{loading ? 'Running Random Forest ML Inference...' : 'Calculate AI Wait Time'}</span>
              </button>
          ...
          <div className="lg:col-span-5 space-y-6">
              ...
              {predictionResult ? (
                <div>
                  <div className="mb-6">
                    <span className="text-xs text-slate-300 block mb-1">
                      Estimated Total Queue Wait Time
                    </span>
                    <div className="text-5xl font-extrabold text-white font-mono tracking-tight mb-2">
                      ~{predictionResult.totalWait} <span className="text-xl text-teal-300 font-sans">mins</span>
                    </div>
                    <p className="text-xs text-slate-300">
                      Based on Position #{predictionResult.queuePosition} in {predictionResult.department}
                    </p>
                  </div>

                  <div className="grid grid-cols-2 gap-3 pt-4 border-t border-white/10 text-center">
                    <div className="bg-white/10 p-3 rounded-2xl border border-white/5">
                      <span className="text-[10px] text-sky-200 block font-semibold">Consultation Duration</span>
                      <span className="text-lg font-bold text-white">~{predictionResult.consultDuration} mins</span>
                    </div>
                    <div className="bg-white/10 p-3 rounded-2xl border border-white/5">
                      <span className="text-[10px] text-teal-200 block font-semibold">Triage Category</span>
                ...
                <div className="text-center py-8 text-slate-300">
                  ...
                  <p className="text-xs font-medium">
                    Select parameters on the left and click "Calculate AI Wait Time" to run inference.
                  </p>
                </div>
              )}
            ...
            <div className="bg-white rounded-3xl p-6 border border-slate-200/80 shadow-xs space-y-4">
              <h3 className="text-sm font-bold text-slate-900 flex items-center gap-2">
                ...
                <span>Model Architecture & Pipeline</span>
              </h3>
              ...
              <div className="p-3 bg-slate-50 rounded-2xl border border-slate-200/70 text-[11px] text-slate-500">
                💡 <span className="font-semibold text-slate-700">Shridevi Institute Capstone Research:</span> Emergency priority tickets automatically trigger high-severity feature weights to prioritize immediate clinical triage.
              </div>
            </div>
