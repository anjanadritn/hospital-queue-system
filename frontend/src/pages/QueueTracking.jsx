              ...
              <>
                ...
                <DepartureCard
                  travelInfo={{
                    ...
                    origin_mode: queueData.origin_mode || queueData.travel_info?.origin_mode,
                    origin_lat: queueData.origin_lat ?? queueData.travel_info?.origin_lat ?? queueData.origin_latitude,
                    origin_lng: queueData.origin_lng ?? queueData.travel_info?.origin_lng ?? queueData.origin_longitude,
                    origin_label: queueData.origin_label || queueData.travel_info?.origin_label || queueData.patient_address,
                    ...
                    location_source: queueData.location_source || queueData.travel_info?.location_source || (queueData.origin_mode === 'preset' ? 'preset' : (queueData.is_approximate_location === false ? 'gps' : 'landmark_approximate')),
